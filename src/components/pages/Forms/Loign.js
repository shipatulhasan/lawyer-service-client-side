...
{/* form */}
        ...
        >
            ...
            <h1 className="text-4xl font-bold text-center text-khaki uppercase">Sign In</h1>
  
            <p className="text-red-600 font-semibold text-xl py-4">{error}</p>

          {/* google signup */}

          <button onClick={handleGoogleSignUp} className="flex items-center justify-center mt-4 text-white transition-colors duration-300 transform border border-khaki w-full bg-slate-100 bg-opacity-20 hover:bg-khaki tracking-widest">
            ...
            >
              ...
              <button type='submit' className='border border-khaki py-3 text-white font-bold tracking-widest uppercase text-base mt-6 bg-slate-100 bg-opacity-20 hover:bg-khaki w-full'>
                    Sign in
                    </button>
