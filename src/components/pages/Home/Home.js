...
const Home = () => {
    return (
        <section className='relative min-h-[400px] md:min-h-[600px] lg:min-h-screen py-16 flex items-center justify-start bg-center bg-no-repeat bg-cover  ' style={{backgroundImage:`url(${banner})`}}>
