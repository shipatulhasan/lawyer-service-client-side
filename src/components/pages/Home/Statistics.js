...
const Statistics = () => {
  ...
  return (
    <div className="px-4 py-16 my-10 md:my-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl  md:px-8 lg:py-20 bg-cover bg-no-repeat  border border-khaki rounded bg-slate-800 shadow-2xl" style={{backgroundImage:`url(${banner})`,backgroundColor:'rgb(0 0 0 / 35%)',backgroundBlendMode:'overlay'}}>
